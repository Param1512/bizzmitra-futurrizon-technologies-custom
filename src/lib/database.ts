...
export const DOMAIN_SCHEMA = {
  ...
  activities: [
  {
    "title": "Automated processing completed for Futurrizon Record #01",
    "subtitle": "Validated according to SaaS & Enterprise Software regulatory standards",
    "timeAgo": "5 mins ago"
  },
  {
  ...
  modules: [
  {
    ...
    "description": "High-density operational telemetry, throughput pipelines, and real-time alerts for SaaS & Enterprise Software Operations Platform.",
    "icon": "Building2"
  },
  {
    "id": "portal",
    "title": "Futurrizon Records Workflow Registry",
  ...
  {
    "id": "REC-101",
    "title": "Primary Futurrizon Execution Workflow",
    "col1": "SaaS & Enterprise Software Core",
  ...
  {
    "id": "REC-102",
    "title": "Secondary works Verification Node",
  ...
  demoUsers: [
  {
    ...
    "email": "lead@futurrizontechnologiespvtltd.com",
    "password": "admin123",
    "role": "Chief SaaS & Enterprise Software Operations Officer",
  ...
  },
  {
    "id": "usr-cm-2",
    "name": "Ananya Iyer",
    "email": "ops@futurrizontechnologiespvtltd.com",
    "password": "ops123",
    "role": "Lead Futurrizon Record Workflow Specialist",
  ...
  },
  {
    "id": "usr-cm-3",
    "name": "Karan Patel",
    "email": "field@futurrizontechnologiespvtltd.com",
    "password": "field123",
  ...
  },
  {
    "id": "usr-cm-4",
    "name": "Sunita Nambiar",
    "email": "audit@futurrizontechnologiespvtltd.com",
    "password": "audit123",
  ...
  roadmap: [
  {
    ...
    "tasks": [
      {
        "id": "t1-1",
        "title": "Initialize PostgreSQL 16 schema for Futurrizon Records",
        "done": true,
        "assignee": "Vikram Malhotra"
      },
      {
        "id": "t1-2",
        "title": "Configure automated input ingestion for SaaS & Enterprise Software Operations Platform",
        "done": true,
  ...
  },
  {
    ...
    "tasks": [
      {
        "id": "t2-1",
        "title": "Deploy Edge Function validation engine for Futurrizon Record triage",
        "done": true,
        "assignee": "Ananya Iyer"
      },
      {
...
const STORAGE_KEY = 'bizzmitra-futurrizon-technologies-custom_db_custom_v1';
const USERS_STORAGE_KEY = 'bizzmitra-futurrizon-technologies-custom_users_custom_v1';
const SPRINTS_STORAGE_KEY = 'bizzmitra-futurrizon-technologies-custom_sprints_custom_v1';
const ACTIVE_SESSION_KEY = 'bizzmitra-futurrizon-technologies-custom_session_custom_v1';
